  ...
  <div class="container-fluid ps-0 pe-0 ps-sm-2 pe-sm-2">
    <form class="row sticky-top bg-gray-200 bg-gradient border-bottom border-2">
      <fieldset class="col-auto mb-0">
        ...
        <div class="form-check">
          <input
            ...
            v-model="picked"
          />
          <label class="form-check-label" for="rdbTzden"> TYZDENNY </label>
        </div>
        <div class="form-check">
          <input
            class="form-check-input"
            ...
            v-model="picked"
          />
          <label class="form-check-label" for="rdbMesiac"> MESACNY </label>
        </div>
        <div class="form-check">
          <input
            class="form-check-input"
            ...
            v-model="picked"
          />
          <label class="form-check-label" for="rdbCustom"> VLASTNY </label>
        </div>
      </fieldset>
      ...
      <div class="col-sm-auto ps-2 mt-sm-4">
        <div class="row mb-2">
          <label for="slZmena" class="col-2 col-sm-3 col-form-label"
            >Zmena</label
          >
          <div class="col">
      ...
      <div class="row justify-content-center">
        ...
        >
          ...
          <span
            v-show="loading"
            class="spinner-border spinner-border me-2"
            style="vertical-align: middle"
          ></span>
          <span v-show="loading" role="status" style="vertical-align: middle"
            >LOADING...</span
          >
        </button>
      </div>
      ...
      <a
        ...
        title="POZNAMKA"
        data-bs-content="Realne namerane hodnoty su reprezentovane farebnymi kruhovymi bodmi. Sive linie medzi vykreslenymi bodmi su LEN odhadovene hodnoty veliciny v danom case"
        >POZNAMKA</a
      >
    </form>
    ...
    <div class="row row-cols-1 row-cols-xxl-2">
      ...
      <div class="col" v-show="zobraz.mojVykon">
        <MyBarChart
          :myChartData="myDataMojVykon"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="
            showModal('POCITANY VYKON', myDataMojVykon, myOptionsTimeComp)
          "
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.DBVykon">
        <MyBarChart
          :myChartData="myDataDBVykon"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="showModal('VYKON', myDataDBVykon, myOptionsTimeComp)"
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.okamzitaSpotreba">
        <MyBarChart
          :myChartData="myDataSpotreba"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="
            showModal('OKAMZITA SPOTREBA', myDataSpotreba, myOptionsTimeComp)
          "
        ></MyBarChart>
      </div>
      <div class="col position-relative" v-show="zobraz.spotrebaZmien">
        <p
          ref="celkovaspotreba"
          class="spotreba-celkon border rounded-2 lh-1 p-1 fw-semibold text-bg-primary"
          v-show="zobraz.spotrebaZmien"
        >
          SPOLU: {{ spotreba_celkom.toFixed(2) }} kWh
        </p>
        <BarChart :myChartData="myDataSpotrebaBAR"></BarChart>
      </div>
      <div class="col" v-show="zobraz.napatie">
        <MyBarChart
          :myChartData="myDataNapatie"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="showModal('NAPATIE', myDataNapatie, myOptionsTimeComp)"
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.prud">
        <MyBarChart
          :myChartData="myDataPrud"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="showModal('PRUD', myDataPrud, myOptionsTimeComp)"
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.teplotaVstup">
        <MyBarChart
          :myChartData="myDataVoda"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="
            showModal(
              'TEPLOTA VODY vstup / vystup',
              myDataVoda,
              myOptionsTimeComp
            )
          "
      ...
      <div class="col" v-show="zobraz.tlak">
        <MyBarChart
          :myChartData="myDataTlak"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="showModal('TLAK', myDataTlak, myOptionsTimeComp)"
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.sobertVstup">
        <MyBarChart
          :myChartData="myDataSobertVstup"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="
            showModal('SOBERT VSTUP', myDataSobertVstup, myOptionsTimeComp)
          "
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.sobertVykon">
        <MyBarChart
          :myChartData="myDataSobertVykon"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="
            showModal('SOBERT VYKON', myDataSobertVykon, myOptionsTimeComp)
          "
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.rzPrisposobenie">
        <MyBarChart
          :myChartData="myDataRzPrisposobenie"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="
            showModal('PRISPOSOBENIE', myDataRzPrisposobenie, myOptionsTimeComp)
          "
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.prietok">
        <MyBarChart
          :myChartData="myDataPrietok"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="showModal('PRIETOK', myDataPrietok, myOptionsTimeComp)"
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.frekvencia">
        <MyBarChart
          :myChartData="myDataFrekvencia"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="
            showModal('FREKVENCIA', myDataFrekvencia, myOptionsTimeComp)
          "
        ></MyBarChart>
      </div>
      <div class="col" v-show="zobraz.teplotaP1">
        <MyBarChart
          :myChartData="myDataTeplotaP1P2Okruh"
          :myChartOptions="myOptionsTimeComp"
          v-on:click="
            showModal(
              'TEPLOTA VODY  pec1 / pec2 / (primarny okruh)',
...
export default {
  ...
  data() {
    ...
    return {
      ...
      myModalData: {
        labels: [0],
        datasets: [
          { data: [0], label: "MODALNE DATA", backgroundColor: "#b34700" },
        ],
      },
      myDataMojVykon: {
        labels: [0],
      ...
      myDataDBVykon: {
        labels: [0],
        datasets: [
          { data: [0], label: "VYKON [W]", backgroundColor: "#339933" },
        ],
      },
      myDataSpotreba: {
        labels: [0],
      ...
      myDataNapatie: {
        ...
        labels: [0],
        datasets: [
          { data: [0], label: "NAPATIE [V]", backgroundColor: "#f87979" },
        ],
      },
      myDataPrud: {
        labels: [0],
        datasets: [
          { data: [0], label: "PRUD [A]", backgroundColor: "#0066ff" },
        ],
      },
      myDataTlak: {
        labels: [0],
        datasets: [
          { data: [0], label: "TLAK [Pa]", backgroundColor: "#000000" },
        ],
      },
      myDataSobertVstup: {
        labels: [0],
        datasets: [
          { data: [0], label: "Sobert VSTUP [?]", backgroundColor: "#ffcccc" },
        ],
      },
      myDataSobertVykon: {
        labels: [0],
        datasets: [
          { data: [0], label: "Sobert VYKON [W]", backgroundColor: "#ffcc99" },
        ],
      },
      myDataVoda: {
        labels: [0],
        datasets: [
          { data: [0], label: "VODA VSTUP [°C]", backgroundColor: "#9933ff" },
          { data: [0], label: "VODA VYSTUP [°C]", backgroundColor: "#ff6600" },
        ],
      },
      myDataFrekvencia: {
        labels: [0],
        datasets: [
          { data: [0], label: "FREKVENCIA [Hz]", backgroundColor: "#cc3300" },
        ],
      },
      ...
      myDataPrietok: {
        labels: [0],
        datasets: [
          { data: [0], label: "PRIETOK [l/s]", backgroundColor: "#3399ff" },
        ],
      },
      myDataTeplotaP1P2Okruh: {
        labels: [0],
        datasets: [
          { data: [0], label: "TEPLOTA P1 [°C]", backgroundColor: "#ff6666" },
          { data: [0], label: "TEPLOTA P2 [°C]", backgroundColor: "#d65cad" },
          {
            data: [0],
            label: "TEPLOTA OKRUH [°C]",
  ...
  methods: {
        ...
        .then((response) => {
          ...
          let PomData = PomLabels.map((zmenaa) => {
            ...
            response.data.forEach(
              (rec) => rec.zmena == zmenaa && (total += rec.spotreba)
            );
          ...
          PomLabels = response.data.map((rec) =>
            this.parsujDatum(rec.dateTime)
          );
          this.TimeBoundary = Helpers.DodajKrajneHodnoty(
            new Date(PomLabels[0]),
            new Date(PomLabels[PomLabels.length - 1])
          );

          //POCITANY VYKON
          PomData = response.data.map((rec) => rec.mojvykon);
          this.myDataMojVykon = {
            labels: PomLabels,
            datasets: [
              {
          ...
          //DB VYKON
          PomData = response.data.map((rec) => rec.vykon);
          this.myDataDBVykon = {
            labels: PomLabels,
            datasets: [
              { data: PomData, label: "VYKON [W]", backgroundColor: "#339933" },
            ],
          };

          //OKAMZITA SPOTREBA
          PomData = response.data.map((rec) => rec.spotreba);
          this.myDataSpotreba = {
            labels: PomLabels,
            datasets: [
              {
          ...
          //NAPATIE
          PomData = response.data.map((rec) => rec.napatie);
          this.myDataNapatie = {
            labels: PomLabels,
            datasets: [
              {
          ...
          this.myDataPrud = {
            labels: PomLabels,
            datasets: [
              { data: PomData, label: "PRUD [A]", backgroundColor: "#0066ff" },
            ],
          };

          //TEPLOTA VODY
          PomData = response.data.map((rec) => rec.tVodaVstup.toFixed(2));
          let PomData1 = response.data.map((rec) => rec.tVodaVystup.toFixed(2));
          this.myDataVoda = {
            labels: PomLabels,
            datasets: [
              {
          ...
          //TLAK
          PomData = response.data.map((rec) => rec.tlak);
          this.myDataTlak = {
            labels: PomLabels,
            datasets: [
              {
          ...
          //SOBERT VSTUP
          PomData = response.data.map((rec) => rec.sobertVstup);
          this.myDataSobertVstup = {
            labels: PomLabels,
            datasets: [
              {
                data: PomData,
          ...
          //SOBERT VYKON
          PomData = response.data.map((rec) => rec.sobertVykon);
          this.myDataSobertVykon = {
            labels: PomLabels,
            datasets: [
              {
                data: PomData,
                label: "SOBERT VYKON  [W]",
          ...
          //RZPRISPOSOBENIE
          PomData = response.data.map((rec) => rec.rzPribenie);
          this.myDataRzPrisposobenie = {
            labels: PomLabels,
            datasets: [
              {
                data: PomData,
                label: "RZ Prisposobenie [?/?]",
                backgroundColor: "#804000",
              },
            ],
          };
          ...
          //FREKVENCIA
          PomData = response.data.map((rec) => rec.frekvencia);
          this.myDataFrekvencia = {
            labels: PomLabels,
            datasets: [
              {
                data: PomData,
          ...
          //PRIETOK
          PomData = response.data.map((rec) => rec.prietokVody);
          this.myDataPrietok = {
            labels: PomLabels,
            datasets: [
              {
          ...
          //-------------------------------------------------------------------------------------------------------------------------------------------------------
          //TEPLOTA P1
          PomData = response.data.map((rec) => rec.teplotaP1);
          this.myDataTeplotaP1 = {
            labels: PomLabels,
            datasets: [
              {
                data: PomData,
          ...
          //TEPLOTA P2
          PomData1 = response.data.map((rec) => rec.teplotaP2);
          this.myDataTeplotaP2 = {
            labels: PomLabels,
            datasets: [
              {
                data: PomData1,
          ...
          //TEPLOTA OKRUH
          let PomData2 = response.data.map((rec) => rec.teplotaOkruh);
          this.myDataTeplotaOkruh = {
            labels: PomLabels,
            datasets: [
              {
                data: PomData2,
    ...
    inicializujOdDo() {
      switch (this.picked) {
        case "WEEK":
          this.tDO = new Date();
          this.tOD = Helpers.WeekBack(this.tDO);
          this.disable_picker = true;
          break;
        case "MONTH":
          this.tDO = new Date();
          this.tOD = Helpers.MonthBack(this.tDO);
          break;
        case "CUSTOM":
          this.tDO = this.dpDO;
          this.tOD = this.dpOD;
  ...
  computed: {
    cp_disable_picker() {
      if (this.picked == "CUSTOM") return false;
      else return true;
    },
    myOptionsTimeComp() {
      return {
